<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="/dashboard">
            <span class="font-weight-bold text-lg">GCTU SCP</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'projects.create' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Publish Project</span>
                </a>
            </li>
